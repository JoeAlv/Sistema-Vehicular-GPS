<%@ Page Title="" Language="C#" MasterPageFile="~/Forms/Shared/PageContent.Master" AutoEventWireup="true" CodeBehind="ConsultVehiclesDate.aspx.cs" Inherits="WebVehicles.Forms.Common.ConsultVehiclesDate" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
     <title>Consultar Vehiculos por fecha - Sistema Vehicular</title>
</asp:Content>
    ...
    <form runat="server" id="form1">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div class="h3 text-center">Consulta de vehiculo por fecha de ingreso</div>
                <div class="form-row">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <asp:GridView ID="GridViewVehicles" runat="server" BackColor="White" BorderColor="#CCCCCC" CssClass="table table-responsive table-hover table-sm table-light"
                AutoGenerateColumns="False" BorderStyle="None" BorderWidth="1px">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Motor" DataField="engine" >
                        <HeaderStyle Width="400px" /></asp:BoundField>
                        <asp:BoundField HeaderText="Modelo" DataField="year" DataFormatString="{0:yyyy}" />
                        <asp:BoundField HeaderText="Transmisión" DataField="transmission" >
                        <HeaderStyle Width="400px" /></asp:BoundField>
                        <asp:BoundField HeaderText="Combustible" DataField="fuel" />
                        <asp:BoundField HeaderText="Tanque" DataField="fueltank" />
